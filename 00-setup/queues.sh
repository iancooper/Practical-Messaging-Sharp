#!/usr/bin/env bash
# Generated from the canonical exercise source (shared/00-setup/queues.sh) by emit.py, which lives in the practical-messaging-samples working directory alongside the five language repos. Do not edit this copy -- edit the canonical source and re-emit.
#
